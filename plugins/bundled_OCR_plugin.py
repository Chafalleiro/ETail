...
class WindowRegionDialog:
    ...
    def _create_window_tab(self, parent):
        ...
        #ttk.Button(button_frame, text="🖱️ Click to Pick", command=self._pick_window_interactive).pack(side=tk.LEFT)
    ...
    def _select_subregion(self):
        ...
        try:
            ...
            #root_window.withdraw()  # ← FIXED
            # Show main window again
            #root_window = self.app.root.winfo_toplevel()
            root_window = self.parent.winfo_toplevel()
            root_window.deiconify()
            
            #self.parent.deiconify()
            messagebox.showerror("Error line 1284", f"Failed to select sub-region: {e}")
    ...
    def _pick_window_interactive(self):
        ...
        #from ocr_modules.region_selector import RegionSelector  # internal import removed
            ...
            # Get the actual root window (Tk instance) not the Frame
            #root_window = self.parent.root.winfo_toplevel()
            #root_window.withdraw()  # ← FIXED
            ...
            window_info = RegionSelector.select_window(selector)
            ...
            if window_info and 'hwnd' in window_info:
                ...
                try:
                    ...
                    print("Error", f"Failed to get window information: {e}")
            else:
                messagebox.showinfo("Cancelled", "Window selection was cancelled.")
                print("Cancelled", "Window selection was cancelled.")

        except Exception as e:
            messagebox.showerror("Error", f"Window selection failed: {e}")
            print("Error", f"Window selection failed: {e}")
    ...
    def _test_window_capture(self):
        ...
        if not self.selected_window:
            messagebox.showwarning("No Window", "Please select a window first.")
            print("No Window", "Please select a window first.")
            return
        ...
        try:
            ...
            print("Test Failed", f"Error: {str(e)}")
...
class RegionSelector:
    ...
    def _configure_window_region(self):
        ...
        root_window = self.app.root.winfo_toplevel()
        dialog = tk.Toplevel(root_window)  # ← FIXED
        dialog.title("Configure Window Capture")
        dialog.geometry("500x400")
        dialog.transient(root_window)  # ← FIXED
        ...
        def test_capture():
            try:
                ...
                if image:
                    ...
                    messagebox.showerror("Test Failed", "Failed to capture window")
                    print("Test Failed", "Failed to capture window")
            except Exception as e:
                messagebox.showerror("Test Failed", f"Error: {e}")
                print("Test Failed", f"Error: {e}")
        ...
        try:
            ...
            def on_click(event):
                ...
                if hwnd and win32gui.IsWindowVisible(hwnd):
                    ...
                    print("Invalid Window", "Please select a valid visible window.")
            ...
            # Ensure we restore the window even on error
            root_window = self.app.root.winfo_toplevel()
            root_window.deiconify()  # ← FIXED
    ...
    def select_region(self):
        ...
        try:
            ...
            self.selector_window = tk.Toplevel(root_window)  # ← FIXED
